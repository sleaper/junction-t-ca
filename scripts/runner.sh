...
for density in $(seq 0 0.01 0.5); do
    ./ca -d $density -a 0.3 -w 1000 -s 5000 -p -y | tail -n 1 >>results/flow_density_03_aggressive.csv
done
...
for density in $(seq 0 0.01 0.5); do
    ./ca -d $density -a 0.6 -w 1000 -s 5000 -p -y | tail -n 1 >>results/flow_density_06_aggressive.csv
done
...
for density in $(seq 0 0.01 0.5); do
    ./ca -d $density -a 0.9 -w 1000 -s 5000 -p -y | tail -n 1 >>results/flow_density_09_aggressive.csv
done
