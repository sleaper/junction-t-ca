...
plt.plot(density_df['density'], density_df['flow'], 'o-', label='0% Aggressive Drivers')
plt.plot(low_aggr['density'], low_aggr['flow'], 's-', label='30% Aggressive Drivers')
plt.plot(med_aggr['density'], med_aggr['flow'], '^-', label='60% Aggressive Drivers')
plt.plot(high_aggr['density'], high_aggr['flow'], 'd-', label='90% Aggressive Drivers')
plt.xlabel('Density')
plt.ylabel('Flow')
